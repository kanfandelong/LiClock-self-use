...
cp build/bootloader/bootloader.bin ../../raspberry_example/target-firmware/
cp build/partition_table/partition-table.bin ../../raspberry_example/target-firmware/
cp build/hello_world.bin ../../raspberry_example/target-firmware/app.bin
```
