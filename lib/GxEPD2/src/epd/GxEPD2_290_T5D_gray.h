...
#ifndef _GxEPD2_290_T5D_gray_H_
#define _GxEPD2_290_T5D_gray_H_
#include "../GxEPD2_EPD.h"

class GxEPD2_290_T5D_gray : public GxEPD2_EPD
{
  public:
    // attributes
    ...
    static const GxEPD2::Panel panel = GxEPD2::GDEW029T5D_gray;
    ...
    int lutgray = 15;
    // constructor
    GxEPD2_290_T5D_gray(int16_t cs, int16_t dc, int16_t rst, int16_t busy);
    // methods (virtual)
...
//private:
    ...
    void _Update_Full();
    void _Update_Part();
    //实际调用的函数    //  Support for Bitmaps (Sprites) to Controller Buffer and to Screen
    ...
    void __writeScreenBufferAgain(uint8_t value);
    // write to controller memory, without screen refresh; x and w should be multiple of 8
    ...
    void __writeImageForFullRefresh(const uint8_t bitmap[], int16_t x, int16_t y, int16_t w, int16_t h, bool invert, bool mirror_y, bool pgm);
    void __writeImageAgain(const uint8_t bitmap[], int16_t x, int16_t y, int16_t w, int16_t h, bool invert, bool mirror_y, bool pgm);
